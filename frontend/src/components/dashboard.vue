...
<div class="h-full backdrop-blur-3xl  from-gray-800  to-cyan-800  bg-gradient-to-r">
    ...
    <div class="container flex flex-wrap items-center justify-between mx-auto">
      <div class="flex md:order-2">
        <button type="button"
          ...
          @click="app.logout()">Log Out</button>
            ...
            <div class="lg:col-span-2">
              <div class="md:col-span-5">
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1">
                  <form class="submit" @submit.prevent="app.shorten(app.input.links)">
                    <input
  ...
  <div  class="grid grid-cols-3">
    <h1 class="text-lg text-white text-center"></h1>
    <Linky v-for="linky in app.linkys" :key="linky" :linky="linky"/>
  </div> 
